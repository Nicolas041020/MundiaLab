...
//    }
    ...
    public Competitor(String name, String surname, String email, String passw, int age, String telephone, String cellphone, String address, String city, String country, boolean winner) {
        this.name = name;
